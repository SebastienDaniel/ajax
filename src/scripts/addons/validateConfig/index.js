 ...
 */
function validateRequestConfiguration(c) {
    ...
    if (typeof c.method === "string") {
        ...
        throw new TypeError("ajax request object expects property 'method' to be one of:\n GET, POST, PUT, DELETE\n Provided:\n" + c.method);
    }
        ...
        if (Object.prototype.toString.call(c.headers) !== "[object Object]") {
            ...
            Object.keys(c.headers).forEach(function(key) {
                if (typeof c.headers[key] !== "string") {
                    throw TypeError("ajax request object 'headers' properties must all be strings.\nProvided " + typeof c.headers[key] + " for " + key);
                }
            })
        }
    }
...
module.exports = validateRequestConfiguration;
