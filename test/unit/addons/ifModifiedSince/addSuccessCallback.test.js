var expect = require("chai").expect,
    ...
    add = require("../../../../src/scripts/addons/ifModifiedSince/addSuccessCallback");

describe("ifModifiedSince.addSuccessCallback()", function() {
    "use strict";
    ...
    it("the success callback should add an entry to cache, with current time", function() {
        ...
        expect(cache.get("someUrl").date).to.eql(Date.now());
